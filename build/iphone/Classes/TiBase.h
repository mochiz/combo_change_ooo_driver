...
// in simulator we redefine to format for combo_change_ooo_driver Developer console
...
{\
	NSString * exceptionName = [@"org.combo_change_ooo_driver." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.combo_change_ooo_driver";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIcombo_change_ooo_driverNativeItemNone = -1, 
	UIcombo_change_ooo_driverNativeItemSpinner = -2,
	UIcombo_change_ooo_driverNativeItemProgressBar = -3,
	
	UIcombo_change_ooo_driverNativeItemSlider = -4,
	UIcombo_change_ooo_driverNativeItemSwitch = -5,
	UIcombo_change_ooo_driverNativeItemMultiButton = -6,
	UIcombo_change_ooo_driverNativeItemSegmented = -7,
	
	UIcombo_change_ooo_driverNativeItemTextView = -8,
	UIcombo_change_ooo_driverNativeItemTextField = -9,
	UIcombo_change_ooo_driverNativeItemSearchBar = -10,
	
	UIcombo_change_ooo_driverNativeItemPicker = -11,
	UIcombo_change_ooo_driverNativeItemDatePicker = -12,
	
	UIcombo_change_ooo_driverNativeItemInfoLight = -13,
	UIcombo_change_ooo_driverNativeItemInfoDark = -14,
	
	UIcombo_change_ooo_driverNativeItemDisclosure = -15,
	
	UIcombo_change_ooo_driverNativeItemContactAdd = -16
};
